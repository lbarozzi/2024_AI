...
if __name__ == "__main__":
    ...
    blocklists = ["Lb_BlockList"]

    # Set the content to be tested
    content = "Un giorno un uomo camminando per strada vide il cadavere sanguinante di uno stegosauro belga e si mise a curare le sue ferite.\n"
    content+= "Scoperto di non poter salvare la creatura le diede l'eutanasia con una motosega a benzina"
